        ...
        <div className="p-4 rounded-xl">
          <div className="flex justify-center mb-4 space-x-8">
            ...
            <div className="flex items-center">
              ...
              <span className="text-sm text-gray-700">Rebonds</span>
            </div>
            <div className="flex items-center">
              <div className="w-3 h-3 bg-green-500 rounded-full mr-2"></div>
              <span className="text-sm text-gray-700">Passes</span>
            </div>
            <div className="flex items-center">
              <div className="w-3 h-3 bg-purple-500 rounded-full mr-2"></div>
              <span className="text-sm text-gray-700">Interceptions</span>
            </div>
          </div>
          
          <div className="h-60 bg-gray-50 rounded-lg p-4 flex items-end justify-around">
            {sortedHistory.map((season, index) => (
              <div key={`bar-${index}`} className="flex flex-col items-center">
                ...
                <div className="text-xs font-medium text-gray-600">{season.year.split('-')[0]}</div>
              </div>
            ))}
          </div>
        </div>
